...
export const PRICE_PLUS = process.env.STRIPE_PRICE_PLUS || 'price_plus_default';
export const PRICE_CARE_PLUS = process.env.STRIPE_PRICE_CARE_PLUS || 'price_care_plus_default';
